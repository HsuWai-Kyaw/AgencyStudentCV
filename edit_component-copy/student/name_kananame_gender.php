          ...
          <td rowspan="2">
               ...
               <div class="d-flex justify-content-evenly pt-4">
                    <div>
                         ...
                         <input type="radio" name="rdogender" id="male" value="男" <?= ($value['gender'] == '男') ? 'checked' : '' ?> style="width:10px;">
                    </div>
                    <div>
                         <label for="female">女</label>
                         <input type="radio" name="rdogender" id="female" value="女" <?= ($value['gender'] == '女') ? 'checked' : '' ?> style="width:10px;">
                    </div>
               </div>
          </td>
     </tr>
