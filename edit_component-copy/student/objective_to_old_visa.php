...
?>
     ...
     <tr>
          ...
          <td colspan="2">
               <div class="d-flex justify-content-evenly pt-4">
                    <div>
                         ...
                         <input type="radio" name="rdoteamwork" value="有" <?= ($value['teamwork'] == '有') ? 'checked' : '' ?> style="width:10px;">
                    </div>
                    <div>
                         <label for="no">無し</label>
                         <input type="radio" name="rdoteamwork" value="無し" <?= ($value['teamwork'] == '無し') ? 'checked' : '' ?> style="width:10px;">
                    </div>
               </div>
          ...
          <td><input type="number" name="family_income" style="width:70px" value="<?= $value['family_income'] ?? "" ?>">チャット
          </td>
     </tr>
     <tr>
     ...
     <tr>
          ...
          <td colspan="3">
               <input type="number" name="planning_money" style="width:70px" value="<?= $value['planning_money'] ?? "" ?>">万
          </td>
     </tr>
     <tr>
     ...
     <tr>
          ...
          <td colspan="3">
               <div class="d-flex justify-content-evenly pt-4">
                    <div>
                         <label for="yes">有</label>
                         <input type="radio" name="rdoform" value="有" <?= ($value['form'] == '有') ? 'checked' : '' ?> style="width:10px;">
                    </div>
                    <div>
                         <label for="no">無し</label>
                         <input type="radio" name="rdoform" value="無し" <?= ($value['form'] == '無し') ? 'checked' : '' ?> style="width:10px;">
                    </div>
               </div>
          </td>
     </tr>
